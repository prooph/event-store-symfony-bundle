...
class BundleTest extends TestCase
{
    ...
    public function it_creates_an_event_store_with_metadata_enrichers()
    {
        ...
        $metadataEnricherPlugin = $container->get('prooph_event_store.metadata_enricher_plugin.main');
        self::assertInstanceOf(MetadataEnricherPlugin::class, $metadataEnricherPlugin);

        $metadataEnricherAggregate = $container->get('prooph_event_store.metadata_enricher_aggregate.main');
